...
from utils import exists, cosine_beta_schedule, extract, noise_like, default
import numpy as np
...
class GaussianDiffusion(nn.Module):
    ...
    def __int__(
        ...
        alphas = 1.0 - betas  # as with paper
        alphas_cumprod = np.cumprod(alphas, axis=0)  # as with paper
    ...
    def q_mean_variance(self, x_start, t):
        ...
        log_variance = extract(self.lo_one_minus_alphas_cumprod, t, x_start.shape)
    ...
    def q_posterior(self, x_start, x_t, t):
        ...
        posterior_log_variance_clipped = extract(self.posterior.log_variance_clipped, t, x_t.shape)
